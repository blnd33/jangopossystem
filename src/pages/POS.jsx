...
export default function POS() {
  ...
  useEffect(() => {
    ...
    const cats = JSON.parse(localStorage.getItem('jango_categories') || '[]');
    setCategories(cats);
  }, []);
  ...
  function addToCart(product) {
    ...
    setCart(prev => {
      ...
      if (existing) {
        if (existing.qty >= product.stock) return alert('Not enough stock!') || prev;
  ...
  function handleCheckout() {
    ...
    if (!amountPaid && paymentMethod !== 'installment') return alert('Please enter amount paid!');
        ...
        <div style={{
          ...
          <div style={{ padding: '20px 24px' }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 12, color: COLORS.textMuted }}>Customer</span>
            ...
            <div style={{
              ...
              {[
                { label: 'Subtotal', value: `$${receipt.subtotal.toFixed(2)}` },
                receipt.discountAmount > 0 && { label: 'Discount', value: `-$${receipt.discountAmount.toFixed(2)}`, color: COLORS.success },
                { label: 'TOTAL', value: `$${receipt.total.toFixed(2)}`, bold: true },
                { label: 'Paid', value: `$${receipt.amountPaid.toFixed(2)}` },
                receipt.change > 0 && { label: 'Change', value: `$${receipt.change.toFixed(2)}`, color: COLORS.success },
                receipt.remaining > 0 && { label: 'Remaining', value: `$${receipt.remaining.toFixed(2)}`, color: COLORS.red },
                ...
                <div key={row.label} style={{
                  ...
                  <span style={{
                    ...
                    color: row.color || COLORS.charcoalMid
                  }}>
                    {row.label}
                  </span>
                  <span style={{
                    ...
                    color: row.color || COLORS.charcoal
                  }}>
                    {row.value}
                  </span>
                </div>
            ...
            <div style={{
              ...
              Payment: <strong>{receipt.paymentMethod.toUpperCase()}</strong>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: COLORS.charcoal }}>
                Thank you for shopping at Jango!
              </div>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              color: COLORS.white, fontSize: 14, cursor: 'pointer',
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 14 }}>
          <input
            ...
            style={{
              ...
              fontSize: 13, outline: 'none', background: COLORS.white
            }}
          />
          <select
            ...
            {filteredProducts.map(product => (
              ...
              >
                ...
                <div style={{ padding: '10px 10px 12px' }}>
                  ...
                  <div style={{
                    fontSize: 14, fontWeight: 800, color: COLORS.red,
            ...
            cart.map(item => (
              <div key={item.id} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  <div style={{ fontSize: 13, fontWeight: 600, color: COLORS.charcoal, flex: 1, paddingRight: 8 }}>
                    {item.name}
                  </div>
                  <button
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ marginLeft: 'auto', fontSize: 14, fontWeight: 700, color: COLORS.charcoal }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 6 }}>
                  <span style={{ fontSize: 11, color: COLORS.textMuted }}>Item discount $</span>
                  <input
                    type="number"
        ...
        <div style={{
          ...
          <div style={{ marginBottom: 12 }}>
            {[
              ...
              discountAmount > 0 && { label: 'Discount', value: `-$${discountAmount.toFixed(2)}`, color: COLORS.success },
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
              {['cash', 'card', 'transfer', 'installment'].map(method => (
                ...
                >
                  {method === 'transfer' ? 'Bank Transfer' : method.charAt(0).toUpperCase() + method.slice(1)}
                </button>
              ))}
            </div>
          </div>
