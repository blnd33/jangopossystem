    ...
    <div style={{ padding: 24, direction: isRTL ? 'rtl' : 'ltr', fontFamily }}>
          ...
          <div style={{ fontSize: 13, color: COLORS.textMuted, marginTop: 2 }}>
            ...
            {totalDebt > 0 && (
              <span style={{ color: COLORS.red, fontWeight: 600 }}>
                {' '}· ${totalDebt.toFixed(2)} {t('totalDebt')}
              </span>
            )}
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 20 }}>
        {[
          ...
          { label: t('totalDebt'), value: `$${totalDebt.toFixed(2)}`, color: COLORS.red },
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <div>
                ...
                <input value={form.email} onChange={e => setForm({ ...form, email: e.target.value })}
                  placeholder="customer@email.com" style={{
                    width: '100%', padding: '9px 12px', border: `1px solid ${COLORS.border}`,
                    borderRadius: 7, fontSize: 13, color: COLORS.charcoal, outline: 'none', boxSizing: 'border-box'
                  }} />
              </div>
              ...
              <div>
                ...
                <select value={form.tag} onChange={e => setForm({ ...form, tag: e.target.value })} style={{
                  width: '100%', padding: '9px 12px', border: `1px solid ${COLORS.border}`,
                  borderRadius: 7, fontSize: 13, color: COLORS.charcoal, outline: 'none',
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', marginTop: 20, flexDirection: isRTL ? 'row-reverse' : 'row' }}>
              ...
              }}>{editingId ? t('save') : t('addCustomer')}</button>
            </div>
          </div>
        </div>
      )}
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20, flexDirection: isRTL ? 'row-reverse' : 'row' }}>
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: 22, fontWeight: 700, color: COLORS.red, fontFamily: 'Georgia, serif', flexShrink: 0
              }}>
                ...
                {viewCustomer.tag && (() => {
                  ...
                  return (
                    <span style={{
                      ...
                      padding: '2px 10px', borderRadius: 20, marginTop: 4, display: 'inline-block'
                    }}>
                      {getTagLabel(viewCustomer.tag)}
                    </span>
                  );
                })()}
              </div>
            ...
            <div style={{ background: COLORS.offWhite, borderRadius: 10, padding: 16, marginBottom: 16 }}>
              {[
                ...
                { label: t('creditLimit'), value: `$${(viewCustomer.creditLimit || 0).toFixed(2)}` },
              ].map(row => (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
              {[
                ...
                { label: t('totalSpent'), value: `$${(viewCustomer.totalSpent || 0).toFixed(2)}` },
              ].map(s => (
            ...
            return (
              ...
              >
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 16, fontWeight: 700, color: COLORS.red, fontFamily: 'Georgia, serif', flexShrink: 0
                }}>
                ...
                <div style={{ flex: 1, textAlign: isRTL ? 'right' : 'left' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexDirection: isRTL ? 'row-reverse' : 'row' }}>
                    ...
                    <span style={{
                      background: tc.bg, border: `1px solid ${tc.border}`,
                      color: tc.text, fontSize: 10, fontWeight: 600, padding: '1px 8px', borderRadius: 20
                    }}>{getTagLabel(customer.tag)}</span>
                  </div>
