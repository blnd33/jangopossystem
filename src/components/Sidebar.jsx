    ...
    <div style={{
      ...
      {!collapsed && (
        <div style={{ textAlign: isRTL ? 'right' : 'left' }}>
          ...
          <div style={{
            width: 36, height: 2.5,
            background: `linear-gradient(${isRTL ? '270deg' : '90deg'}, ${COLORS.red}, transparent)`,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <JangoLogo collapsed={collapsed} t={t} isRTL={isRTL} language={language} />
        {!collapsed && (
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    flexDirection: isRTL && !collapsed ? 'row-reverse' : 'row',
                    background: isActive
                      ? `linear-gradient(${isRTL ? '270deg' : '90deg'}, ${COLORS.red}22, ${COLORS.red}08)`
                      : 'none',
                    border: 'none',
